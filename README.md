...
| | [Is it a bird?](./01-practical-deep-learning-for-coders/01-is-it-a-bird-creating-a-model-from-your-own-data.ipynb) | Creating a model from custom data |
...
| | [Image Model Comparison](./01-practical-deep-learning-for-coders/03-which-image-models-are-best.ipynb) | Comparing different architectures |
| **04** | [MNIST Basics](./01-practical-deep-learning-for-coders/04_mnist_basics.ipynb) | Building the "Hello World" of CV |
| | [NLP for Beginners](./01-practical-deep-learning-for-coders/04-getting-started-with-nlp-for-absolute-beginners.ipynb) | Intro to Natural Language Processing |
...
| | [Linear Model from Scratch](./01-practical-deep-learning-for-coders/05-linear-model-and-neural-net-from-scratch.ipynb) | Re-implementing the core logic |
| | [Why use a Framework?](./01-practical-deep-learning-for-coders/05-why-you-should-use-a-framework.ipynb) | The benefits of high-level abstractions |
